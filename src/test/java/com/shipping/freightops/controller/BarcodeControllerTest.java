...
@ContextConfiguration(classes = {BarcodeController.class, BarcodeControllerTest.BarcodeServiceDummyConfig.class})
class BarcodeControllerTest {
    ...
    void getCode128Barcode_returns200() throws Exception {
        mockMvc.perform(get("/api/v1/barcodes/code128")
    ...
    void getQrCode_returns200() throws Exception {
        mockMvc.perform(get("/api/v1/barcodes/qr")
